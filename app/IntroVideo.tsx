...
const VIDEOS = [
  ...
  {
    // Mobil: tam genislik, sol-alt (degismedi). Masaustu: sabit 270x135,
    ...
    className:
      "fixed bottom-0 left-0 z-10 h-auto w-full md:left-auto md:right-[-15px] md:h-[135px] md:w-[270px] md:object-contain",
  },
];
