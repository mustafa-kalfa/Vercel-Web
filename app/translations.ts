...
export const TRANSLATIONS: Record<Language, Translation> = {
  tr: {
    ...
    podcastEp002: "Hadislerin yazılması",
  ...
  en: {
    ...
    podcastEp002: "The writing down of ḥadīth",
