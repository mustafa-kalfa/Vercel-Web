...
export const TRANSLATIONS: Record<Language, Translation> = {
  tr: {
    ...
    podcastEp001: "Hz. Peygamber ve sahâbe döneminde rivâyet",
    podcastEp002: "Hadislerin yazılması, sadrın zabtından satrın zabtına",
    podcastEp003: "Fitne ve isnâdın başlangıcı",
    podcastEp004: "Tedvîn süreci",
    podcastEp005: "Tasnîf dönemi, öncesi ve sonrası",
    podcastEp006: "İkinci asır rivâyetleri ve ilk musannifler",
    podcastEp007: "Mihne Hâdisesi",
    podcastEp008: "Ref' olgusu ve rivâyetin dönüşümü",
    playerPlay: "Oynat",
  ...
  ar: {
    ...
    podcastEp001: "الرواية في عهد النبي ﷺ والصحابة",
    podcastEp002: "كتابة الحديث، من ضبط الصدور إلى ضبط السطور",
    podcastEp003: "الفتنة وبداية الإسناد",
    podcastEp004: "عملية التدوين",
    podcastEp005: "عصر التصنيف، ما قبله وما بعده",
    podcastEp006: "روايات القرن الثاني والمصنفون الأوائل",
    podcastEp007: "محنة خلق القرآن",
    podcastEp008: "ظاهرة الرفع وتحول الرواية",
    playerPlay: "تشغيل",
  ...
  en: {
    ...
    podcastEp001: "Transmission in the era of the Prophet and the Companions",
    podcastEp002: "The writing down of ḥadīth, from ḍabṭ al-ṣudūr to ḍabṭ al-suṭūr",
    podcastEp003: "The Fitna and the beginning of the isnād",
    podcastEp004: "The process of tadwīn",
    podcastEp005: "The era of taṣnīf, before and after",
    podcastEp006: "Second-century narrations and the earliest muṣannifs",
    podcastEp007: "The Miḥna",
    podcastEp008: "The phenomenon of rafʿ and the transformation of transmission",
    playerPlay: "Play",
    playerPause: "Pause",
