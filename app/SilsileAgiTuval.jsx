...
/* SILSILE AGININ <CANVAS> DENEMESI -- yalnizca /ag-sinamasi.

   Yayindaki surum app/SilsileAgi.jsx (SVG) ve /ravi-iliski-aglari/harita
   onu kullaniyor. Bu dosya onun kopyasi; cizim katmani adim adim
   <canvas>a tasinacak. Ikisi de app/silsileVeri.js'ten besleniyor,
   yani terceme islendikce iki sayfada da ayni veri gorunuyor.

   NEDEN CANVAS DENENIYOR: SVG'de her kenar ve dugum bir DOM ogesi ve
   tarayici kaydirmada hepsini yeniden boyuyor. Kalem cihaz uzayindan
   cikarilinca (bkz. 7065bf9) ve kisa kenarlar elenince (6c8c7ff)
   telefondaki kasma azaldi ama bitmedi. Canvas'ta tek bir oge var,
   cizim dogrudan piksel tamponuna gidiyor ve DOM hic buyumuyor.

   BEDELI, PESINEN: canvas'ta metin secilemez, ekran okuyucu icerigi
   goremez, tiklama hedefi kendiliginden olusmaz -- hepsi elle
   yazilacak. Deneme tutmazsa bu dosya silinir, yayindaki surum hic
   dokunulmamis olur.

   KARSILASTIRMA ICIN: iki sayfa yan yana acilip ayni gorunumde ayni
   islem yapilarak olculmeli, yoksa "daha akici" bir his olmaktan
   oteye gecmez. */
