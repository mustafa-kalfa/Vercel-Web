/* DENEME VERISI -- yalnizca /ag-sinamasi kullaniyor (SilsileAgiSinama.jsx).
   app/silsileVeri.js'in KOPYASI; uzerine Zehebi'nin Siyer'inden
   dogrulanan yeni ravi ve baglar ekleniyor (Mustafa, 2026-09-04:
   "kutub-i sitte muellifleri ve onlarin bir ust tabakasini Zehebi'nin
   siyerinden kontrol et ... bunlarin hepsini ag-sinamasi uzerinde
   yap").

   ONAYLANIRSA: buradaki EKLER app/silsileVeri.js'e tasinir ve bu dosya
   SILINIR. Iki dosyayi uzun sure yan yana tutma -- 2026-08-30'da ayni
   catal acilmis ve is bitince kapatilmisti.

   Eklenenler dosyanin icinde "SIYER EKI" yorumuyla isaretli. */
